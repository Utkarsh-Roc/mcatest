    ...
    const serviceData = [
        {
            ...
            "services": [
                {
                    "id": "1",
                    "image": "/img/services/artistmanaged/1.jpeg"
                },
                {
                    "id": "2",
                    "image": "/img/services/artistmanaged/2.jpeg"
                },
                {
                    "id": "3",
                    "image": "/img/services/artistmanaged/3.jpeg"
                },
                {
                    "id": "4",
                    "image": "/img/services/artistmanaged/4.jpeg"
                }
            ]
        }
    ];
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="MCA Worldwide offers comprehensive artist management services including bookings, promotions, and career development for artists across entertainment industries." />
                <meta name="keywords" content="Artist Management, MCA Worldwide, Celebrity Booking, Artist Promotion, Event Talent" />
            </Head>
            <LightTheme>
