      ...
      <div className="swiper-container parallax-slider">
        {!load ? (
          <Swiper
            ...
            className={`swiper-wrapper ${styles['intro-image-positioning']}`}
            slidesPerView={1}
          >
            {introData.map((slide) => (
              <SwiperSlide key={slide.id} className="swiper-slide" >
                <div
                  className={`bg-img valign ${styles['intro-slide-positioning']}`}
        ...
        <div className="social-icon">
          <a href="https://www.facebook.com/musicculturearts/" target={"_blank"} rel="noreferrer">
            <i className="fab fa-facebook-f"></i>
          </a>
          <a href="https://www.instagram.com/worldwide_mca/" target={"_blank"} rel="noreferrer">
            <i className="fab fa-instagram"></i>
          </a>
          <a href="https://www.linkedin.com/company/music-culture-&-arts" target={"_blank"} rel="noreferrer">
