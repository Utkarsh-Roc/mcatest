...
import services6Data from "../../data/sections/services6.json";

const Services6 = ({ withBG, withPadding, halfBG, withOutTitle }) => {
  return (
    <section
    ...
    >
      <div className="container">
        ...
        <div className="row">
          {services6Data.map((item, index) => (
            <div className="col-lg-6"  key={item.id} >
              <div
                className={`item ${
                  index != services6Data.length - 1 ? "md-mb50" : ""
                } wow fadeInUp`}
                data-wow-delay={
