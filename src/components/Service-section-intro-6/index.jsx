...
import Split from "../Split";
        ...
        <div className="row">
          <div className="mb-3">
            ...
            {/* <span className="mb-3">Services</span> */}
              <h2 className="mb-3   wow words  chars splitting" data-splitting>Conferences<b> & Award Nights</b>  .</h2>
 ...
 export default ServiceSectionIntro6;