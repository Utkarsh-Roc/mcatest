...
const ServiceSectionShowcases = ({data}) => {
  ...
  const Data = data[0].services;
  return (
    <header className="slider showcase-carus " >
      <div id="content-carousel-container-unq-1  " style={{backgroundColor:"#232323"}} className="swiper-container">
        {!load ? (
          <Swiper 
            speed={1000}
            mousewheel={false}
...
export default ServiceSectionShowcases;
