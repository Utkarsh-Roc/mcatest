                      ...
                      <div className="caption">
                        <Split>
                          <h1 data-splitting className="words chars splitting">
                            <div className="thin">{slide.title.first}</div> Stories
                          </h1>
                        </Split>
                        <p>
        ...
        {!load ? (
          ...
          >
            <SwiperSlide
              ...
              style={{ backgroundImage: 'url("/img/slid/bg1.jpg")' }}
              data-overlay-dark="6"
            ></SwiperSlide>
            <SwiperSlide
              className="swiper-slide bg-img"
              style={{ backgroundImage: 'url("/img/slid/bg2.jpg")' }}
              data-overlay-dark="6"
            ></SwiperSlide>
            <SwiperSlide
              className="swiper-slide bg-img"
              style={{ backgroundImage: 'url("/img/slid/bg3.jpg")' }}
              data-overlay-dark="6"
            ></SwiperSlide>
          </Swiper>
        ) : null}
